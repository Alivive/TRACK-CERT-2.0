...
import { Sun, Moon, LayoutDashboard, User, Layers, PlusCircle, Upload, FileText, Settings, BookOpen, MessageSquare } from 'lucide-react';
...
const Sidebar = ({ activePage, onPageChange, isOpen }) => {
  ...
  const navItems = [
    ...
    { id: 'send_message', label: 'Send Message', icon: <MessageSquare size={16} />, section: 'ADMIN', adminOnly: true },
